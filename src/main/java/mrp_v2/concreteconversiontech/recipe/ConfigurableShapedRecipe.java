package mrp_v2.concreteconversiontech.recipe;
...
public class ConfigurableShapedRecipe implements ICraftingRecipe, IShapedRecipe<CraftingInventory>
{
    ...
    public ConfigurableShapedRecipe(ResourceLocation idIn, String groupIn, int recipeWidthIn, int recipeHeightIn,
    ...
    {
        return ObjectHolder.CCT_SHAPED_RECIPE_SERIALIZER;
    }
            ...
            implements IRecipeSerializer<CCTShapedRecipe>
    {
        ...
        public CCTShapedRecipe read(ResourceLocation recipeId, JsonObject json)
        {
            ...
            return new ConfigurableShapedRecipe(recipeId, group, i, j, ingredients, itemstack, splitPattern, overrides);
        }
        ...
        public CCTShapedRecipe read(ResourceLocation recipeId, PacketBuffer buffer)
        {
            ...
            return new ConfigurableShapedRecipe(recipeId, group, width, height, ingredients, result, pattern, overrides);
        }
