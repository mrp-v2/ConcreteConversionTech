...
public class ConcreteConverterTier4TileEntity extends AbstractConcreteConverterTileEntity
{
    ...
    {
        TileEntityType<ConcreteConverterTier4TileEntity> tileEntityType =
                TileEntityType.Builder.create(ConcreteConverterTier4TileEntity::new,
                        ObjectHolder.CONCRETE_CONVERTER_TIER_4_BLOCK).build(null);
