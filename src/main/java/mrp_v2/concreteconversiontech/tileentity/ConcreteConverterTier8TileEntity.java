...
public class ConcreteConverterTier8TileEntity extends AbstractConcreteConverterTileEntity
{
    ...
    {
        TileEntityType<ConcreteConverterTier8TileEntity> tileEntityType =
                TileEntityType.Builder.create(ConcreteConverterTier8TileEntity::new,
                        ObjectHolder.CONCRETE_CONVERTER_TIER_8_BLOCK).build(null);
