...
@OnlyIn(Dist.CLIENT)
@EventBusSubscriber(modid = ConcreteConversionTech.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
    ...
    @SubscribeEvent public static void registerBlockColors(final ColorHandlerEvent.Block event)
    {
        event.getBlockColors()
                .register((state, reader, pos, tint) -> reader != null && pos != null ?
                                ...
                                BiomeRegistry.field_244200_a.getWaterColor(), CCTObjectHolder.CONCRETE_CONVERTER_TIER_1_BLOCK,
                        CCTObjectHolder.CONCRETE_CONVERTER_TIER_2_BLOCK,
                        CCTObjectHolder.CONCRETE_CONVERTER_TIER_3_BLOCK,
                        CCTObjectHolder.CONCRETE_CONVERTER_TIER_4_BLOCK,
                        CCTObjectHolder.CONCRETE_CONVERTER_TIER_5_BLOCK,
                        CCTObjectHolder.CONCRETE_CONVERTER_TIER_6_BLOCK,
                        CCTObjectHolder.CONCRETE_CONVERTER_TIER_7_BLOCK,
