...
public class CCTObjectHolder {
	...
	static {
		...
		CONCRETE_CONVERTER_TIER_3_BLOCK = new ConcreteConverterBlock(Blocks.IRON_BLOCK, 3,
				ConcreteConverterTier3TileEntity::new);
		CONCRETE_CONVERTER_TIER_4_BLOCK = new ConcreteConverterBlock(Blocks.GOLD_BLOCK, 4,
				ConcreteConverterTier4TileEntity::new);
		CONCRETE_CONVERTER_TIER_5_BLOCK = new ConcreteConverterBlock(Blocks.DIAMOND_BLOCK, 5,
				ConcreteConverterTier5TileEntity::new);
		CONCRETE_CONVERTER_TIER_6_BLOCK = new ConcreteConverterBlock(Blocks.EMERALD_BLOCK, 6,
