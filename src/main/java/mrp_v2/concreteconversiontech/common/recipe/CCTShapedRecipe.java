...
public class CCTShapedRecipe implements ICraftingRecipe, IShapedRecipe<CraftingInventory> {
	...
	public CCTShapedRecipe(ResourceLocation idIn, String groupIn, int recipeWidthIn, int recipeHeightIn,
			NonNullList<Ingredient> recipeItemsIn, ItemStack recipeOutputIn, String[] pattern,
	 ...
	 */
	private boolean checkMatch(CraftingInventory craftingInventory, int p_77573_2_, int p_77573_3_,
			boolean p_77573_4_) {
	...
	public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>>
		...
		public CCTShapedRecipe read(ResourceLocation recipeId, JsonObject json) {
			...
			String[] pattern = CCTShapedRecipe
					.shrink(CCTShapedRecipe.patternFromJson(JSONUtils.getJsonArray(json, "pattern")));
	...
	public static class Override {
		...
		public static Override deserializeOverride(JsonObject json) {
			...
			Map<String, Ingredient> keyOverrides = CCTShapedRecipe
					.deserializeKey(JSONUtils.getJsonObject(json, "key_overrides"));
		...
		public NonNullList<Ingredient> apply(NonNullList<Ingredient> original, String[] pattern,
