...
public class ObjectHolder
{
    ...
    {
        event.getRegistry()
                .registerAll(CONCRETE_CONVERTER_TIER_1_BLOCK, CONCRETE_CONVERTER_TIER_2_BLOCK,
                        CONCRETE_CONVERTER_TIER_3_BLOCK, CONCRETE_CONVERTER_TIER_4_BLOCK,
                        CONCRETE_CONVERTER_TIER_5_BLOCK, CONCRETE_CONVERTER_TIER_6_BLOCK,
                        CONCRETE_CONVERTER_TIER_7_BLOCK, CONCRETE_CONVERTER_TIER_8_BLOCK);
    }

    @SubscribeEvent public static void registerItems(final RegistryEvent.Register<Item> event)
    {
        event.getRegistry()
                .registerAll(CONCRETE_CONVERTER_TIER_1_BLOCK_ITEM, CONCRETE_CONVERTER_TIER_2_BLOCK_ITEM,
                        CONCRETE_CONVERTER_TIER_3_BLOCK_ITEM, CONCRETE_CONVERTER_TIER_4_BLOCK_ITEM,
                        CONCRETE_CONVERTER_TIER_5_BLOCK_ITEM, CONCRETE_CONVERTER_TIER_6_BLOCK_ITEM,
                        CONCRETE_CONVERTER_TIER_7_BLOCK_ITEM, CONCRETE_CONVERTER_TIER_8_BLOCK_ITEM);
    }

    @SubscribeEvent public static void registerTileEntities(final RegistryEvent.Register<TileEntityType<?>> event)
    {
        event.getRegistry()
                .registerAll(CONCRETE_CONVERTER_TIER_1_TILE_ENTITY_TYPE, CONCRETE_CONVERTER_TIER_2_TILE_ENTITY_TYPE,
                        CONCRETE_CONVERTER_TIER_3_TILE_ENTITY_TYPE, CONCRETE_CONVERTER_TIER_4_TILE_ENTITY_TYPE,
                        CONCRETE_CONVERTER_TIER_5_TILE_ENTITY_TYPE, CONCRETE_CONVERTER_TIER_6_TILE_ENTITY_TYPE,
                        CONCRETE_CONVERTER_TIER_7_TILE_ENTITY_TYPE, CONCRETE_CONVERTER_TIER_8_TILE_ENTITY_TYPE);
    }

    @SubscribeEvent public static void registerContainers(final RegistryEvent.Register<ContainerType<?>> event)
    {
        event.getRegistry()
                .registerAll(CONCRETE_CONVERTER_TIER_1_CONTAINER_TYPE, CONCRETE_CONVERTER_TIER_2_CONTAINER_TYPE,
                        CONCRETE_CONVERTER_TIER_3_CONTAINER_TYPE, CONCRETE_CONVERTER_TIER_4_CONTAINER_TYPE,
                        CONCRETE_CONVERTER_TIER_5_CONTAINER_TYPE, CONCRETE_CONVERTER_TIER_6_CONTAINER_TYPE,
                        CONCRETE_CONVERTER_TIER_7_CONTAINER_TYPE, CONCRETE_CONVERTER_TIER_8_CONTAINER_TYPE);
    }
}
