...
public class RegistryHandler
{
	...
	public static void registerBlocks(final RegistryEvent.Register<Block> event) {
		event.getRegistry().registerAll(ObjectHolder.CONCRETE_CONVERTER_TIER_1_BLOCK,
	...
	public static void registerItems(final RegistryEvent.Register<Item> event) {
		event.getRegistry().registerAll(ObjectHolder.CONCRETE_CONVERTER_TIER_1_BLOCK_ITEM,
	...
	public static void registerTileEntities(final RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().registerAll(ObjectHolder.CONCRETE_CONVERTER_TIER_1_TILE_ENTITY_TYPE,
	...
	public static void registerContainers(final RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().registerAll(ObjectHolder.CONCRETE_CONVERTER_TIER_1_CONTAINER_TYPE,
